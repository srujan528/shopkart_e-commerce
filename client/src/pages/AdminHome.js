            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight mt-2 text-white flex items-center gap-3">
                  👑 ShopKart Admin Dashboard
                </h1>
                <p className="text-slate-300 text-sm mt-1 max-w-xl">
                  Manage store inventory, edit product details, update prices, and track customer orders.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  ...
                  className="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold px-5 py-2.5 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
                >
                ...
                <Link
                  to="/admin/Orders"
                  className="bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold px-5 py-2.5 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
